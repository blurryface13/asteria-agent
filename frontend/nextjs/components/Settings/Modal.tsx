...
const Modal: React.FC<ChatBoxProps> = ({ chatBoxSettings, setChatBoxSettings }) => {
      ...
      >
        ...
        >
          <div className="relative">
            ...
            {/* Modal content */}
            <div className="relative flex flex-col rounded-lg overflow-hidden bg-white border border-gray-200/60 shadow-md hover:shadow-teal-400/10 transition-shadow duration-300">
              {/* Header with subtler accent */}
              <div className="bg-white p-5 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-semibold text-gray-900">
                    <span className="mr-2">⚙️</span>
                    <span className="text-teal-600">Preferences</span>
                  </h3>
                  <button
              ...
              {/* Body with content */}
              <div className="relative p-6 flex-auto bg-white/95 modal-content">
                ...
                {activeTab === 'report_settings' && (
                  <div className="App">
                    <header className="App-header">
                      ...
                      {chatBoxSettings.report_type === 'multi_agents' && (
                        <div className="form-group">
                          <label htmlFor="LANGGRAPH_HOST_URL" className="agent_question">
                            LangGraph Host URL (required for Multi Agents Report)
                          </label>
                          <input
                            type="text"
                            name="LANGGRAPH_HOST_URL"
                            id="LANGGRAPH_HOST_URL"
              ...
              {/* Footer with actions */}
              <div className="flex items-center justify-end p-4 border-t border-gray-200 bg-white/80">
                <button
                  className="mr-3 px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 rounded-md transition-colors duration-200"
                  onClick={() => setShowModal(false)}
                >
                  Cancel
                </button>
                <button
                  className="px-6 py-2.5 text-sm font-medium rounded-md text-white bg-teal-600 hover:bg-gradient-to-br hover:from-teal-500/95 hover:via-cyan-500/90 hover:to-teal-600/95 shadow-sm hover:shadow-teal-400/20 transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-teal-500 focus:ring-offset-1 focus:ring-offset-white"
  ...
  return (
    <div className="settings">
      <button
        className="bg-white text-gray-900 px-6 py-3 rounded-lg shadow-sm hover:shadow-teal-400/10 transition-all duration-300 border border-gray-200 hover:border-teal-500/30"
        type="button"
