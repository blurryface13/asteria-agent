...
export default function MobileResearchContent({
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-3.5rem)] bg-gradient-to-b from-white to-gray-50">
      {/* Status Bar - Shows when researching or can show share button */}
      {(localLoading || localProcessing || (currentResearchId && onShareClick)) && (
        <div className="flex items-center justify-between px-4 py-2 bg-gray-50/90 border-b border-gray-200/50 backdrop-blur-sm">
          {/* Left side - status */}
