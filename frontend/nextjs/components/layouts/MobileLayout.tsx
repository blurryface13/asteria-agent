  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200/50 shadow-md">
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center space-x-2">
            {loading && (
              <button
                onClick={onStop}
                className="p-2 rounded-full bg-red-50 text-red-600 hover:bg-red-500/30"
            ...
            {showResult && onNewResearch && (
              <button
                ...
                className="p-2 rounded-full bg-sky-50 text-sky-600 hover:bg-sky-500/30"
        ...
        {showHistory && (
          <div className="px-4 py-3 bg-gray-50/90 border-t border-gray-200/50 animate-slide-down shadow-lg max-h-[70vh] overflow-y-auto custom-scrollbar">
            ...
            {history.length > 0 ? (
              <div className="space-y-2">
                {history.map((item) => (
                  <button
                    ...
                    className="w-full bg-white/60 hover:bg-gray-50 rounded-lg p-3 text-left transition-colors focus:outline-none focus:ring-1 focus:ring-teal-500/50 border border-gray-200/30"
                  >
              ...
              <div className="text-center py-6">
                <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gray-200/50 flex items-center justify-center">
                ...
                <button 
                  onClick={onNewResearch} 
                  className="mt-3 px-4 py-2 text-xs text-teal-600 bg-teal-50 hover:bg-teal-100 rounded-md transition-colors"
                >
                  Start New Research
                </button>
              </div>
            ...
            {history.length > 0 && (
              <div className="mt-3 pt-2 border-t border-gray-200/30 flex justify-center">
                <a 
                  href="/history" 
                  className="text-xs text-teal-600 hover:text-teal-600 transition-colors"
                >
        ...
        {showSettings && (
          <div className="px-4 py-3 bg-gray-50/90 border-t border-gray-200/50 animate-slide-down shadow-lg">
