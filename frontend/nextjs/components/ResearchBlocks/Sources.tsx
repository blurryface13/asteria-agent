          ...
          {sources.map((source) => {
            ...
            return (
              <a 
                ...
                className="inline-flex items-center gap-1.5 rounded border border-white/[0.08] bg-white/[0.05] px-2 py-1 text-xs text-white/55 transition-colors hover:bg-white/[0.10] hover:text-teal-200"
                title={source.name}
              >
