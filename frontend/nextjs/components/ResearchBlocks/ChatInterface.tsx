    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto p-4 space-y-4 mb-4 custom-scrollbar">
        {renderedMessages.length === 0 ? (
          <div className="text-center p-8 rounded-lg bg-gradient-to-r from-white/5 to-gray-800/5 border border-gray-300/20 backdrop-blur-sm relative overflow-hidden">
            {/* Ambient decoration */}
          ...
          <>
                ...
                <div 
                  className={`max-w-[80%] p-3 rounded-lg shadow-md ${
                    msg.role === 'user'
                      ...
                      : 'bg-gradient-to-r from-gray-50 to-white text-gray-900 shadow-gray-300/40 border border-gray-200'
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="max-w-[80%] p-3 rounded-lg shadow-md bg-gradient-to-r from-gray-50 to-white text-gray-900 shadow-gray-300/40 border border-gray-200 relative overflow-hidden">
                  ...
                  <div className="markdown-content text-sm sm:text-base relative z-10">
                    {/* Heading */}
                    <div className="h-7 bg-gray-200/50 rounded-md w-3/5 mb-4 animate-pulse"></div>
                    
                    {/* Paragraph */}
                    <div className="space-y-2 mb-4">
                      <div className="h-4 bg-gray-200/50 rounded-full w-full animate-pulse"></div>
                      <div className="h-4 bg-gray-200/50 rounded-full w-[95%] animate-pulse"></div>
                      <div className="h-4 bg-gray-200/50 rounded-full w-[98%] animate-pulse"></div>
                      <div className="h-4 bg-gray-200/50 rounded-full w-[90%] animate-pulse"></div>
                    </div>
                    
                    {/* List items */}
                    <div className="space-y-2 mb-4">
                      <div className="flex">
                        <div className="h-4 w-4 rounded-full bg-gray-200/50 mt-1 mr-2 animate-pulse"></div>
                        <div className="h-4 bg-gray-200/50 rounded-full w-[70%] animate-pulse"></div>
                      </div>
                      <div className="flex">
                        <div className="h-4 w-4 rounded-full bg-gray-200/50 mt-1 mr-2 animate-pulse"></div>
                        <div className="h-4 bg-gray-200/50 rounded-full w-[80%] animate-pulse"></div>
                      </div>
                      <div className="flex">
                        <div className="h-4 w-4 rounded-full bg-gray-200/50 mt-1 mr-2 animate-pulse"></div>
                        <div className="h-4 bg-gray-200/50 rounded-full w-[75%] animate-pulse"></div>
                      </div>
                    </div>
                    
                    {/* Code block */}
                    <div className="rounded-md bg-gray-50/70 p-3 mb-4">
                      <div className="space-y-2">
                        <div className="h-4 bg-gray-100/60 rounded-full w-[85%] animate-pulse"></div>
                        <div className="h-4 bg-gray-100/60 rounded-full w-[90%] animate-pulse"></div>
                        <div className="h-4 bg-gray-100/60 rounded-full w-[80%] animate-pulse"></div>
                      </div>
                    </div>
                    
                    {/* Final paragraph */}
                    <div className="space-y-2">
                      <div className="h-4 bg-gray-200/50 rounded-full w-[88%] animate-pulse"></div>
                      <div className="h-4 bg-gray-200/50 rounded-full w-[92%] animate-pulse"></div>
                      <div className="h-4 bg-gray-200/50 rounded-full w-[60%] animate-pulse"></div>
                    </div>
                  </div>
                </div>
              </div>
