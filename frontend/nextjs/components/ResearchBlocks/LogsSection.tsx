...
const LogsSection = ({ logs }: OrderedLogsProps) => {
  ...
  return (
    <div className="container mt-5 h-auto w-full shrink-0 rounded-xl border border-white/[0.08] bg-white/[0.04] p-5 shadow-[0_12px_36px_rgba(2,6,23,0.12)] backdrop-blur-md">
