...
const InputArea: FC<TInputAreaProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <form
        className="mx-auto flex pt-2 pb-2 w-full items-center justify-between rounded-xl border border-gray-200/50 bg-white/90 backdrop-blur-sm px-3 shadow-md relative overflow-hidden z-10"
        onSubmit={(e) => {
          e.preventDefault();
          if (reset) reset();
          handleSubmit(promptValue);
