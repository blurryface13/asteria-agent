...
const Accordion: React.FC<AccordionProps> = ({ logs }) => {
  ...
  return (
    <div id="accordion-collapse" data-accordion="collapse" className="mt-4 bg-white rounded-lg">
      {processedLogs.map((log, index) => (
        <div key={index}>
          ...
          >
            <div className="p-5 border border-b-0 border-gray-900 dark:border-gray-900 dark:bg-white text-gray-900">
