...
const ResearchPanel: React.FC<ResearchPanelProps> = ({
  ...
  return (
    <>
      {/* Panel Header */}
      <div className="flex justify-between items-center px-3 py-3 border-b border-gray-200/60 bg-white/40">
      ...
      <div className="flex-1 overflow-y-auto p-2 custom-scrollbar bg-white/20">
