      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="sidebar-overlay md:hidden fixed inset-0 bg-white bg-opacity-50 backdrop-blur-sm z-40" 
      ...
      >
        ...
        <div 
          className={`h-full transition-all duration-300 text-gray-900 overflow-hidden 
            ${isOpen 
              ? 'bg-white/80 backdrop-blur-md shadow-2xl shadow-black/30 p-3 sm:p-4' 
              : 'bg-transparent p-0'
            }`}
        >
            ...
            {!isOpen ? (
              ...
              >
                <div className="flex justify-between items-center mb-5 sm:mb-6">
                  ...
                  <button
                    onClick={toggleSidebar}
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center bg-gray-50/60 text-gray-900 rounded-full shadow-lg hover:bg-gray-50 transition-all duration-300 group"
                ...
                <div className="overflow-y-auto h-[calc(100vh-150px)] sm:h-[calc(100vh-190px)] pr-1 custom-scrollbar">
                  {history.length === 0 ? (
                    <div className="text-center py-8 sm:py-10 px-4">
                      ...
                      <h3 className="text-lg font-medium text-gray-600 mb-2">No research history yet</h3>
                    ...
                    <ul className="space-y-2 sm:space-y-3">
                      {history.map((item) => (
                        <motion.li 
                          key={item.id}
                          className="relative rounded-xl transition-all duration-300 overflow-hidden group bg-white/40 hover:bg-gray-50/60 border border-gray-200/30 hover:border-gray-600/50 backdrop-blur-sm"
                        ...
                        >
                          ...
                          >
                            <h3 className="font-medium truncate text-gray-700 text-sm sm:text-base transition-colors duration-200 group-hover:text-teal-600">{item.question}</h3>
                          ...
                          <button
                            ...
                            className="absolute top-2 right-2 p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity text-gray-500 hover:text-gray-900 hover:bg-gray-100"
