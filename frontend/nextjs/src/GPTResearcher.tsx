    ...
    <>
      ...
      {showScrollButton && showResult && (
        <button
          ...
          className="fixed bottom-8 right-8 flex items-center justify-center w-12 h-12 text-gray-900 bg-[rgb(168,85,247)] rounded-full hover:bg-[rgb(147,51,234)] transform hover:scale-105 transition-all duration-200 shadow-lg z-50"
        >
          <svg 
