"""Configuration management for Asteria Researcher.

This module provides the Config class that manages all configuration
settings for Asteria Researcher including LLM providers, embeddings,
...
class Config:
    """Configuration manager for Asteria Researcher.
    ...
    def parse_llm(llm_str: str | None) -> tuple[str | None, str | None]:
        ...
        from asteria_researcher.llm_provider.generic.base import _SUPPORTED_PROVIDERS
    ...
    def parse_embedding(embedding_str: str | None) -> tuple[str | None, str | None]:
        ...
        from asteria_researcher.memory.embeddings import _SUPPORTED_PROVIDERS
