...
class WorkerPool:
    def __init__(self, max_workers: int, rate_limit_delay: float = 0.0):
        ...
        Note:
            ...
            This means if you have multiple AsteriaResearcher instances (e.g., in deep research),
    ...
    async def throttle(self):
        ...
        This ensures that even with multiple concurrent AsteriaResearcher instances
