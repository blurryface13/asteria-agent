...
**终端 1 —— 后端**
```bash
cd "/Users/dora/Documents/项目/code/reference-repos/gpt-researcher"
...
**终端 2 —— 前端**
```bash
cd "/Users/dora/Documents/项目/code/reference-repos/gpt-researcher/frontend/nextjs"
npm run dev
```
...
- `.env` 已配置好 DeepSeek(LLM,取自 JChatMind 项目)+ 智谱 embedding-3,检索源用免费的 DuckDuckGo
